    ...
    <div className="flex flex-col gap-4 mt-auto">
      ...
      <div className="flex gap-3">
        <Button 
          ...
          className="flex-1 border-green-600 text-green-700 hover:bg-green-50 h-12 text-base font-medium"
        >
        ...
        <Button 
          ...
          className={`flex-1 h-12 text-base font-medium shadow-lg ${!canBuy ? 'bg-gray-300' : 'bg-green-600 hover:bg-green-700 shadow-green-200'}`}
        >
